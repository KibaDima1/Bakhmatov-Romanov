...
<div id="top">
	...
	<ul id="menu">
		...
		<li><a href="contact_details.html">Контакты</a></li>
	</ul>
</div>
<div id="header">
...
<div id="wrap_bg"><div id="contentwrap">
	...
	<div id="body_area">
		...
		<form id="tour" action="" method="post">
			...
			<div><p>Страна <input name="country" type="text" value=""> </p></div>
			<div><p>Город <input name="town" type="text" value=""></p></div>
			<div><p>Отель <input name="hotel" type="text" value=""></p></div>
			<div><p>Звездность (1-5) <input name="stars" type="number" value=""></p></div>
			<div><p>Дата тура <input name="date_tour" type="date" value=""></p></div>
			<div><p>Стоимость <input name="cost" type="number" value=""></p></div>
			<div><p>Дней <input name="days" type="number" value=""></p></div>
			<div><p>Описание <input name="about" type="text" value=""></p></div>
